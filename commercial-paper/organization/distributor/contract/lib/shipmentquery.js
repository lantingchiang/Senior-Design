...
class ShipmentQueryUtils {
    ...
    * @param {Integer} shipmentUUID the shipment UUID 
    * WHAT
    */
    async getAssetHistory(shipmentUUID) {

        let ledgerKey = await this.ctx.stub.createCompositeKey(this.name, [shipmentUUID]);
...
module.exports = ShipmentQueryUtils;
